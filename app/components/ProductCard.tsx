        ...
        <div className="space-y-2 pt-1">
          ...
          {onShowHistory && (
            <button
              ...
              className="w-full text-center text-xs text-[var(--text-secondary)] transition-colors hover:text-[var(--accent-blue)]"
            >
              Historique des prix{appearanceCountLabel ? ` · ${appearanceCountLabel}` : ""}
            </button>
          )}
        </div>
      </div>
